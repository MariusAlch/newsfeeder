    ...
    <>
      ...
      <Formik
        ...
        onSubmit={(values: Values) => {
          axios
            .post(
              `${getClientConfig().API_URL}/api/agents/register`,
              {
                email: values.email,
            ...
            .then(() => {
              sendToast(toaster => toaster.info({ message: "Email verification sent" }));
          ...
          <Root>
            ...
            <FormContainer>
              ...
              <Form>
                ...
                <p style={{ fontSize: 10 }}>
                  By using NewsFeeder you agree with{" "}
                  <SimpleLink style={{}} href="/terms" target="_blank" rel="noopener noreferrer">
...
(Register as any).getInitialProps = ctx => {
  const { req, res } = ctx;
  if (req && !!req.user) {
    res.writeHead(302, {
